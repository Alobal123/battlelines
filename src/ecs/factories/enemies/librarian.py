...
DEFAULT_LIBRARIAN_LOADOUT: Sequence[str] = ()


def create_enemy_librarian(
    world: World,
    *,
    ability_names: Iterable[str] | None = None,
    max_hp: int = 30,
) -> int:
    """Spawn the Arcane Librarian enemy."""

    loadout = tuple(ability_names) if ability_names is not None else DEFAULT_LIBRARIAN_LOADOUT
    ...
    enemy_entity = world.create_entity(
        ...
        Affinity(base={"arcane": 1, "order": 2}),
        Character(
            slug="librarian",
