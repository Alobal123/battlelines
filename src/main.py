...
from ecs.systems.skills import SkillPoolSystem, SkillChoiceSystem, ApplySkillEffectsSystem
...
class BattlelinesWindow(Window):
    def __init__(self):
        ...
        self.location_pool_system = LocationPoolSystem(self.world, self.event_bus)
